...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a3gpilpwvbm7of-ats.iot.us-east-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "asdafsdfsd" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "nrf-352656100221525" ///< Thing Name of the Shadow this device is associated with
